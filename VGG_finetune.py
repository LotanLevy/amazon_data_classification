...
def main():
    ...
    train_dataloader = DataLoader("train_dataset", args.train_file, args.cls_num, args.input_size, args.output_path)
    val_dataloader = DataLoader("val_dataset", args.val_file, args.cls_num, args.input_size, args.output_path)
